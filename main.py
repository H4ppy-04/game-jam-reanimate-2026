...
# queue_sound(resource_path("assets/mainMenu.ogg"))
...
speech_dialogue_box_upside_down = pygame.transform.flip(speech_dialogue_box, 0, True)


roll_sfx = [
    pygame.mixer.Sound(resource_path(f"assets/diceRoll{i}.ogg")) for i in range(1, 3)
]
queue_sound(pygame.Sound(resource_path("assets/gambling.ogg")), music_channel)
shop_sound = pygame.Sound(resource_path("assets/shopping.ogg"))

transition_sound = pygame.mixer.Sound(resource_path("assets/transition.ogg"))
buy_sound = pygame.mixer.Sound(resource_path("assets/buyItem.ogg"))
...
play_sound(pygame.Sound(resource_path("assets/mainMenu.ogg")), music_channel)
            ...
            match game_state:
                case game_state.MENU:
                    if event.key == pygame.K_RETURN:
                        ...
                        play_sound(
                            pygame.Sound(resource_path("assets/gambling.ogg")), music_channel,
                        )
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            match game_state:
                case game_state.MENU:
                    ...
                    stop_sound(music_channel)
                    play_sound(
                        pygame.Sound(resource_path("assets/gambling.ogg")),
                        music_channel,
                    )
